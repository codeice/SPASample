...
var tree_data = {
	'JiangDing' : {name: '嘉定体育网', type: 'folder'}
...
tree_data['JiangDing']['additionalParameters'] = {
	'children' : {
		'News' : {name: '体育新闻', type: 'folder'},
		'Place' : {name: '体育场馆', type: 'folder'}
...
//tree_data['News']['additionalParameters'] = {
//	'children' : {
//		'Pictures' : {name: '图片新闻', type: 'item'},
//		'Dynamic': { name: '新闻动态', type: 'item' },
//		'Media' : {name: '媒体报道', type: 'item'}
//	}
//}
tree_data['JiangDing']['additionalParameters']['children']['News']['additionalParameters'] = {
	'children' : {
	    'Pictures': { name: '图片新闻', type: 'item' },
	    'Dynamic': { name: '新闻动态', type: 'item' },
	    'Media': { name: '媒体报道', type: 'item' }
...
tree_data['JiangDing']['additionalParameters']['children']['Place']['additionalParameters'] = {
    'children': {
        'fitness': { name: '健身区域', type: 'item' },
        'Category': { name: '场所类别', type: 'item' }
        //'hatchbacks' : {name: 'Hatchbacks', type: 'item'},
        //'hybrids' : {name: 'Hybrids', type: 'item'},
        //'suvs' : {name: 'SUVs', type: 'item'},
        //'sedans' : {name: 'Sedans', type: 'item'},
...
//tree_data['Place']['additionalParameters'] = {
//	'children' : {
//	    'fitness': { name: '健身区域', type: 'item' },
//	    'Category': { name: '场所类别', type: 'item' }
//	}
